...
client = MongoClient('172.31.17.181', 29031)
db = client.airstats
...
def mainPrompt():
    ...
    print()
    userValue = raw_input('Enter your choice here: ')
    if userValue == '1':
        value = raw_input('What state would you like to see? ')
        ...
        state = raw_input('What state would you like to see? ')
        getAirportCodesInState(state)
    elif userValue == '5':
        airport = raw_input('What airport would you like to see? ')
        probabilityOfCancellation(airport)
    elif userValue == '6':
        airport = raw_input('What airport would you like to see? ')
        averageDepartureDelayAtAirport(airport)
    elif userValue == '7':
        carrier = raw_input('What carrier would you like to see? ')
        ...
        airport1 = raw_input('From airport: ')
        airport2 = raw_input('to airport: ')
        ...
        year = raw_input('What year would you like to see? ')
